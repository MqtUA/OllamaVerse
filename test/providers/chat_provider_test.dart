...
void main() {
  ...
  group('ChatProvider', () {
    ...
    test('handles errors when fetching models', () async {
      ...
      when(
        mockOllamaService.getModels(),
      ).thenThrow(OllamaConnectionException('Test error'));
    ...
    test(
      ...
      skip:
          'This test requires refactoring ChatProvider to accept StorageService as a parameter',
    );

    test(
      'sendMessage calls OllamaService.generateResponse',
      () {
